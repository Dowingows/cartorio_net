...
////////callbacks
	...
	for (loopMove=0;loopMove<amountSlide;loopMove++)
	{
		...
		if(allLinks[loopMove]!=''){
			...
			//
			$('.camera_target_content .cameraContent:eq('+loopMove+')',wrap).append('<a class="camera_link" href="'+allLinks[loopMove]+'" '+dataBox+' target="'+allTargets[loopMove]+'">' + '<img src="' + allImg[loopMove] + '"></a>');
		}
